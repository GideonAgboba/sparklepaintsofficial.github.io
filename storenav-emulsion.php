          ...
          <div class="card-foot p-4">
            ...
            <?php
              ...
              if (isset($_POST["search_eml_int"])) {
                ...
                $resultSet = $mysqli->query("SELECT * FROM emulsion_interior WHERE title = '$search_eml_int'");
          ...
          <div class="card-foot p-4">
            ...
            <?php
              ...
              if (isset($_POST["search_eml_ext"])) {
                ...
                $resultSet = $mysqli->query("SELECT * FROM emulsion_exterior WHERE title = '$search_eml_ext'");
                if ($resultSet->num_rows > 0) {
                  while ($rows = $resultSet->fetch_assoc()) {
                    $title = $rows["title"];
                    $des = $rows["description"];
