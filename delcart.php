...
?>
          ...
          <div class="p-0 container-fluid col-lg-12" style="margin: 0px !important;padding: 0px !important;">
...
<div class="container hide">
  <div class='row container-fluid mt-5' style="margin-top: 10em !important; z-index: 20000px !important;">
    <div>
        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            <blockquote class="mt-5">
              <div class="row mt-5">
                <div class="white-text text-center" style="font-size: 50px;">
                   <p class="mt-5">We offer quality products and sevices...</p>
                </div>
              </div>
            </blockquote>
          </div>
          ...
          <div class="item">
            <blockquote class="mt-5">
              <div class="row mt-5">
                <div class="white-text text-center" style="font-size: 50px;">
                  <p class="mt-5">We have been tested, and we are trusted</p>
              </div>
            </blockquote>
          </div>
          <!-- Quote 3 -->
          <div class="item">
            <blockquote class="mt-5">
              <div class="row mt-5">
                <div class="white-text text-center" style="font-size: 50px;">
                  <p class="mt-5">Affordable prices for quality paints</p>
                </div>
              </div>
            </blockquote>
          </div>
        ...
        <div class="controls-wrapper">
          <div class="controls">
            ...
            <div class="dot"></div>
              ...
              <div class="container col-lg-4 hide">
